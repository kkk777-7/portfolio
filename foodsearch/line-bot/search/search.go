...
const (
	...
	HOTPEPPER_JQ_QUERY  = ".results.shop[] | { name: .name, access: .mobile_access, budget: .budget.average, url: .urls.pc, photo: .photo.mobile.l, lat: .lat, lng: .lng, coupon: .coupon_urls.sp }"
