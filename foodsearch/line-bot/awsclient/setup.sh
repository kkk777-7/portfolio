...
aws dynamodb create-table --endpoint-url http://localhost:8000 --cli-input-json file://shops_table.json
aws dynamodb batch-write-item --endpoint-url http://localhost:8000 --request-items file://shops_table_data.json